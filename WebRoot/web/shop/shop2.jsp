...
<section>
        ...
        <div class="row">
            <div class="span12">
                <article style="position: relative;">
                    ...
                    <%=shop.getBusintr() %>
                    </p><img src="<%=shop.getLogo() %>" style="position: absolute;right: 0px;top: 0px;" />
                    <hr>
                </article>
            </div>
        </div>
	...
	<%
		int rowhead = 1;
		int next = 1;
		ArrayList<Shoppro> list = new ArrayList<Shoppro>();
        ...
        <div class="row">
            <article>
                <div class="span12" style="padding-bottom: 10px;">
                    <a>我们的图片墙</a>
                    <p data-toggle="collapse" data-target="#other">
                       	这里展示了我们的一些产品和实体照片 (<%=pro.size() %>)
                       	<span id="imgcontrol" class="pull-right btn">展开</span> 
                       	<script type="text/javascript">
                       	var imgareaid = "#other";
                       	$(document).ready(function(){
                       		$(imgareaid).collapse('hide');
                       		$(imgareaid).on('hidden', function () {
                               	$("#imgcontrol").text("展开")
                               	});
                       		$(imgareaid).on('shown', function () {
                               	$("#imgcontrol").text("收起");
                               	});
                       	});
...
<div class="services">
    ...
    <%
		if(pro.size() != 0)
		{
		list = new ArrayList<Shoppro>(pro);
        ...
        %>
			...
			%>
                <a href="#" class="thumbnail">
                  <img  src="<%=list.get(i).getProimg()%>"  style="width: 260px; height: 180px;">
                </a>
              </li>
        <%
