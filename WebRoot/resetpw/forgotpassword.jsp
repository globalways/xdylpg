...
<html>
  ...
  <div class="container">
      ...
      <form class="form-signin" action="<%=basePath %>getemail" method="post">
        <h4 class="form-signin-heading">输入您的邮箱地址</h4>
        <input type="text" class="input-block-level" placeholder="账户名/邮箱" name="email" />
        <%
		...
		<%} %>
		<input type="text" class="input-block-level" placeholder="验证码 点击图片可更换" name="vrfcd" />
