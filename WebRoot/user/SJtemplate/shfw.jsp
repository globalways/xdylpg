...
var deletePro = function(id,obj)
{
  ...
  <body>
  <input type="hidden" name="nav" value='2-nav-3' />
    <form class="form-horizontal" action="" method="post">
                ...
                <div class="controls">
                  ...
                  <%
                  	if(model.getShopnum()!=null)
                  		out.print("<input type='hidden' name='shopnum' value='"+model.getShopnum()+"' />");
                   %>
              ...
              <!-- news -->
              <div class="control-group">
                <label class="control-label" for="inputIntro">最新活动</label>
                <div class="controls">
