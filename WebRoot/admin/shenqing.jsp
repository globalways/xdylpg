          ...
          <div class="span3">
            ...
            <div class="accordion" id="accordion-969416">
              ...
              <div class="accordion-group">
                ...
                <div id="accordion-element-181694" class="accordion-body in collapse">
                  <div class="accordion-inner">
                 
                      <ul class="nav nav-list bs-docs-sidenav">
                        <li class="nav-header">用户信息</li> 
                        <li><a href="./liuyan.jsp"><i class="icon-chevron-right"></i>留言管理</a></li>
                        <li class="active"><a href="./shenqing.jsp"><i class="icon-chevron-right"></i> 入驻申请</a></li>
                        <li><a href="./jianyi.jsp"><i class="icon-chevron-right"></i> 意见反馈</a></li>
                         <li class="divider"></li>
              ...
              <div class="accordion-group">
                ...
                <div id="accordion-element-598597" class="accordion-body collapse">
                  <div class="accordion-inner">
                      <ul class="nav nav-list bs-docs-sidenav">
                        ...
                        <li class="active"><a href="#transitions"><i class="icon-chevron-right"></i>商铺商店</a></li>
            ...
            <!-- 内容开始 -->
              ...
              <tbody>
                <tr>
                  ...
                  <td>XXX@qq.com</td>
                  <td>
                    <button class="btn" type="button" data-toggle="modal" data-target="#queren" title="删除该申请"><i class="icon-trash"></i></button>
                    ...
                    <button class="btn" type="button" data-toggle="modal" data-target="#myModal" title="通过申请"><i class="icon-ok"></i></button>
                    <i class="icon-check" title="已经查看或者回复"></i>
              <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                  <h5 id="myModalLabel">确认通过申请吗？</h5>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                  ...
                  <button class="btn btn-primary">确认通过申请</button>
                </div>
              </div>
