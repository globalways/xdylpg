...
%>
            ...
            <ul class="breadcrumb">
              ...
              <li class="active"><%=ccs.getSorname() %></li>
            </ul>
            <!-- 站点导航结束 -->
...
<TABLE cellSpacing=0 cellPadding=2 width="100%" align=center border=0>
  <TBODY>
  <TR>
  	<input type="hidden" name='sornum' value=<%=ccs.getSornum() %> />					
    <TD align=middle width=100 height=30> <label class="control-label">分类名称</label></TD>
    <TD><INPUT type='text' style="WIDTH: 200px" maxLength="200" name="sorname" value='<%=ccs.getSorname() %>'/> <FONT color=#ff0000>*</FONT></TD>
  </TR>
  <TR>
...
switch(t)
  ...
  <TR>
    ...
    <TD><input type='text' maxlength="6" value=<%=ccs.getSorord() %> style="WIDTH: 60px" name="sorord"/> </TD></TR>
  <TR>
  ...
  <TR id="hid1">
    ...
    <TD><input type='text' name='sortem' id='SortTemplate' value=<%=ccs.getSortem() %> />  <img src="./images/help.gif" class="tTip" title="该分类使用的列表的模板的文件名"></TD>
  </TR>
  <TR id="hid2">
    <TD align=middle height=30>内容页模板</TD>
    <TD><input type='text' name='contem' id='ContentTemplate'  value=<%=ccs.getContem() %>  />   <img src="./images/help.gif" class="tTip" title="该分类的内容详细页使用的模板的文件名">    </TD>
  </TR>
  <TR id="hid3">
...
doChange(document.getElementById("IcoPath"),document.getElementById("ImageFileList"))
  ...
  <TR>
    ...
    <TD> <input type='text' maxlength="200" style="WIDTH: 450px" value='<%=ccs.getPtitle() %>' name="ptitle"/> </TD>
  </TR>
  <TR>
    <TD align=middle height=30>页面关键词</TD>
    <TD> <input type='text' maxlength="200" style="WIDTH: 450px" value='<%=ccs.getPkeyw() %>'  name="pkeyw"/> </TD>
  </TR>
  <TR>
    <TD align=middle height=30>页面描述</TD>
    <TD>  <TEXTAREA class="textarea" style="WIDTH: 450px" name="pdesc" value=<%=ccs.getPdesc() %> rows="3"></TEXTAREA>    </TD>
  </TR>
    </TBODY></TABLE>
</DIV>
