          ...
          <div class="span3">
            ...
            <div class="accordion" id="accordion-969416">
                ...
                <div id="accordion-element-181694" class="accordion-body collapse">
                  <div class="accordion-inner">
                      ...
                      <ul class="nav nav-list bs-docs-sidenav">
                        ...
                        <li><a href="#transitions"><i class="icon-chevron-right"></i> 入驻申请</a></li>
                        <li class="active"><a href="#modals"><i class="icon-chevron-right"></i> 意见反馈</a></li>
                         <li class="divider"></li>
                ...
                <div id="accordion-element-598597" class="accordion-body collapse">
                  <div class="accordion-inner">
                      <ul class="nav nav-list bs-docs-sidenav">
                        ...
                        <li class="active"><a href="#overview"><i class="icon-chevron-right"></i>全&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;部</a></li>
              ...
              <div class="accordion-group">
                ...
                <div id="accordion-element-598598" class="accordion-body in collapse">
                  <div class="accordion-inner">
                      <ul class="nav nav-list bs-docs-sidenav">
...
<table class="table table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      <a class="btn btn-primary" href="#" title="点击查看详细信息"><i class="icon-list-alt icon-white"></i></a>
                      <a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#" title="更多操作"><span class="caret"></span></a>
                      <ul class="dropdown-menu">
                        <li><a href="#"><i class="icon-pencil"></i> 编辑</a></li>
                        <li><a href="#"><i class="icon-trash"></i> 彻底删除</a></li>
                        <li><a href="#"><i class="icon-ban-circle"></i> 移至回收站</a></li>
                        <li class="divider"></li>
                        <li><a href="#"><i class="i"></i>修改密码</a></li>
                      </ul>
                    </div>
