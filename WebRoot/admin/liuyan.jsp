                ...
                <div id="accordion-element-181694" class="accordion-body in collapse">
                  <div class="accordion-inner">
                      ...
                      <ul class="nav nav-list bs-docs-sidenav">
                        ...
                        <li  class="active"><a href="./liuyan.jsp"><i class="icon-chevron-right"></i>留言管理</a></li>
            ...
            <table class="table table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td>XXX@qq.com</td>
                  <td>
                    <button class="btn" type="button" data-toggle="modal" data-target="#queren" title="删除该留言"><i class="icon-trash"></i></button>
